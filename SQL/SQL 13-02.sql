...
-- Thời gian đã tạo: Th2 13, 2025 lúc 08:03 AM
...
CREATE TABLE `anhsp` (
  `id` int NOT NULL,
  `idsp` int NOT NULL,
  `IMG` varchar(100) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '404.jpg'
...
(233, 44, '../Upload/Product/34-1.webp'),
(234, 44, '../Upload/Product/34-2.webp'),
(235, 44, '../Upload/Product/34-3.webp'),
(236, 44, '../Upload/Product/34-4.webp'),
(237, 44, '../Upload/Product/34-5.webp'),
(238, 44, '../Upload/Product/34-6.webp'),
(239, 44, '../Upload/Product/34-7.webp'),
(240, 44, '../Upload/Product/34-8.webp');
...
CREATE TABLE `anhtintuc` (
  ...
  `image` varchar(100) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '404.jpg'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `banner` (
  ...
  `Loaihienthi` varchar(50) COLLATE utf8mb3_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `donhang` (
  ...
  `Thoigian` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Không xác định',
...
CREATE TABLE `hosonguoidung` (
  `id` int NOT NULL,
  `Diachinguoidung` text COLLATE utf8mb3_unicode_ci NOT NULL,
  `SDT` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `imgmotasanpham` (
  ...
  `image` varchar(120) COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `nguoidung` (
  ...
  `Ten` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
...
INSERT INTO `nguoidung` (`id`, `Quen`, `Ten`, `Email`, `Matkhau`) VALUES
(1, 2, ' Nguyễn Đình Huân', 'huanndps38821@gmail.com', '12345'),
(2, 1, 'Hoàng Công Nhật', 'Nhat123@gmail.com', '11111'),
(4, 1, 'Huan', 'Huan@gmail.com', '12432321ed'),
(5, 1, 'dcđ', 'sxs', 'xsxsx'),
(6, 1, 'sxsx', 'sxsx', 'sxs'),
(7, 1, 'ádfd', 'sdvfg', 'dfvbg');
...
CREATE TABLE `phuongthitran` (
  ...
  `Quanhuyen` varchar(100) COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `sanpham` (
  ...
  `Giaban` int NOT NULL,
  `Sale` varchar(10) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'No',
  `Tilegiamgia` int DEFAULT NULL,
  `URL_Youtube` varchar(70) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `Soluongconlai` int DEFAULT NULL,
  `Dacdiemnoibat` text COLLATE utf8mb3_unicode_ci NOT NULL,
  `Soluongsao` int NOT NULL DEFAULT '1',
  `Tronghopcogi` text COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `thanhpho` (
  `id` int NOT NULL,
  `Tenthanhpho` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
CREATE TABLE `tintuc` (
  `id` int NOT NULL,
  `iddm` int NOT NULL,
  `Tieude` varchar(100) COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `youtube` (
  ...
  `Url` varchar(70) COLLATE utf8mb3_unicode_ci NOT NULL,
  `Trangthai` int NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
--
-- AUTO_INCREMENT cho bảng `hosonguoidung`
--
ALTER TABLE `hosonguoidung`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `hosonguoidung`
  ADD CONSTRAINT `hosonguoidung_ibfk_1` FOREIGN KEY (`id`) REFERENCES `nguoidung` (`id`);
